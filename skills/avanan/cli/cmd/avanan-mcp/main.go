...
func main() {
	...
	case "http":
		...
		fmt.Fprintf(os.Stderr, "avanan-mcp serving MCP over streamable HTTP at %s\n", *addr)
...
// defaultTransport reads PP_MCP_TRANSPORT when set, else stdio. The flag surface
// lets one binary serve stdio locally and streamable HTTP when hosted in a
// container, matching the other 59 connectors.
